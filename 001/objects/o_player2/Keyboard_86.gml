...
if place_meeting(x , y , H_L1_drop) 
{
	...
	player_helm = 100;
	helm_resist = 0.7;
	audio_play_sound_at(sound_helpick,x,y,0,0,0,1,false,2);
}
//撿拾Lv2頭盔的情況
...
if place_meeting(x , y , A_L1_drop) 
{
	...
	player_vest = 120;
	vest_resist = 0.7;
	audio_play_sound_at(sound_vestpick,x,y,0,0,0,1,false,2);
}
//撿拾Lv2護甲的情況
...
if place_meeting(x , y , med_drop) && player_hp != 100
{
   ...
   audio_play_sound_at(sound_med,x,y,0,0,0,1,false,2);
}