  ...
  RG_drop_random = irandom_range(1,2);
	//生成狙擊1把
  instance_create_depth(irandom_range(500,4620) , irandom_range(0,1548) , 1 , gun_SG_drop);
    //生成衝鋒槍3把 
  ...
  instance_create_depth(irandom_range(500,4620) , irandom_range(0,1548) , 1 , A_L1_drop);
    //生成二級甲2個
  instance_create_depth(irandom_range(500,4620) , irandom_range(0,1548) , 1 , A_L2_drop);
  instance_create_depth(irandom_range(500,4620) , irandom_range(0,1548) , 1 , A_L2_drop);
    //生成三級甲1個
  ...
  instance_create_depth(irandom_range(500,4620) , irandom_range(0,1548) , 1 , H_L1_drop);
    //生成二級頭2個
  instance_create_depth(irandom_range(500,4620) , irandom_range(0,1548) , 1 , H_L2_drop);
  instance_create_depth(irandom_range(500,4620) , irandom_range(0,1548) , 1 , H_L2_drop);
    //生成三級頭1個
  instance_create_depth(irandom_range(500,4620) , irandom_range(0,1548) , 1 , H_L3_drop);
